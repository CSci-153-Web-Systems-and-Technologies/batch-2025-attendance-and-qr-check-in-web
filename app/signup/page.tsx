...
import { signup } from "./actions"; // Import the signup action
  ...
  return (
    <div className="min-h-screen flex w-full bg-[var(--background)] transition-colors duration-300">
      ...
      <div className="hidden lg:flex w-1/2 bg-blue-50 items-center justify-center relative overflow-hidden p-4">
           {/* Re-using your nice image logic */}
           <img 
             src="/left.png" 
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-8 md:p-12 lg:px-24 text-gray-900 dark:text-gray-200">
        ...
        {/* Logo */}
        <div className="flex justify-end mb-6 lg:absolute lg:top-8 lg:right-12">
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-6">
            <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white transition-colors">Create an Account</h1>
            <p className="text-gray-500 dark:text-gray-400 text-sm transition-colors">
              Join VSCAN as a participant or organizer!
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                type="text"
                required
                className="w-full px-4 py-2 rounded-lg bg-white border border-gray-300 text-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <select
                  name="role"
                  className="w-full px-4 py-2 rounded-lg appearance-none bg-white border border-gray-300 text-gray-900 dark:bg-gray-800 dark:border-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 cursor-pointer"
                >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 mt-4 bg-gradient-to-r from-blue-600 to-cyan-400 hover:opacity-90 text-white font-bold rounded-lg shadow-lg transform active:scale-[0.99] transition-all disabled:opacity-50"
            >
          ...
          <div className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link href="/login" className="text-cyan-600 dark:text-cyan-500 font-semibold hover:underline">
              Log in
            </Link>
          </div>
